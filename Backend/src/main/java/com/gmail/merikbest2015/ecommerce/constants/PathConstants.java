...
public class PathConstants {
    ...
    public static final String PERFUMES = "/perfumes"; // legacy (kept for backward compat)
    public static final String PRODUCTS = "/products"; // new
    ...
    public static final String API_V1_PERFUMES = API_V1 + PERFUMES; // legacy
    public static final String API_V1_PRODUCTS = API_V1 + PRODUCTS; // new
    ...
    public static final String DELETE_BY_PERFUME_ID = "/delete/{perfumeId}"; // legacy
    public static final String DELETE_BY_PRODUCT_ID = "/delete/{productId}"; // new
    ...
    public static final String PERFUME_ID = "/{perfumeId}"; // legacy
    public static final String PRODUCT_ID = "/{productId}"; // new
    public static final String IDS = "/ids";
    public static final String SEARCH = "/search";
    public static final String SEARCH_GENDER = SEARCH + "/gender";
    public static final String SEARCH_VENDOR = SEARCH + "/vendor"; // new
    public static final String SEARCH_PERFUMER = SEARCH + "/perfumer"; // legacy
    public static final String SEARCH_CATEGORY = SEARCH + "/category"; // new
    public static final String SEARCH_TEXT = SEARCH + "/text";
    public static final String GRAPHQL_IDS = GRAPHQL + IDS;
    public static final String GRAPHQL_PERFUMES = GRAPHQL + PERFUMES; // legacy
    public static final String GRAPHQL_PRODUCTS = GRAPHQL + PRODUCTS; // new
    public static final String GRAPHQL_PERFUME = GRAPHQL + "/perfume"; // legacy
    public static final String GRAPHQL_PRODUCT = GRAPHQL + "/product"; // new
}
