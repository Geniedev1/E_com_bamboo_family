...
describe("products slice tests", () => {
    ...
    it("should fetchProductsByQuery dispatches fulfilled on success", async () => {
        ...
        mock.onPost(API_BASE_URL + PRODUCTS_GRAPHQL_PRODUCTS).reply(200, { data: { products: mockProductsResponse } });
    ...
    it("should fetchProductsByIdsQuery dispatches fulfilled on success", async () => {
        ...
        mock.onPost(API_BASE_URL + PRODUCTS_GRAPHQL_IDS).reply(200, { data: { productsIds: mockProductsResponse } });
